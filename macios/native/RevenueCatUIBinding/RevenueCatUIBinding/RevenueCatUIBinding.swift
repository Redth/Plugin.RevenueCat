...
@objc(RevenueCatUIManager)
public class RevenueCatUIManager : NSObject
{
...
private final class PaywallPresentationDelegate: NSObject, PaywallViewControllerDelegate {
    private weak var owner: RevenueCatUIManager?
    private let callback: (NSString?, NSError?) -> Void
    private var completed = false

    init(owner: RevenueCatUIManager, callback: @escaping (NSString?, NSError?) -> Void) {
        self.owner = owner
