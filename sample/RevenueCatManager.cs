...
#elif ANDROID
public class RevenueCatManagerAndroid : Java.Lang.Object, IRevenueCatManager, RevenueCat.IRevenueCatEntitlementsUpdatedListener
{
    public void Initialize(object platformContext, bool debugLog, string appStore, string apiKey, string userId)
    {
        RevenueCat.RevenueCatManager.Initialize((Android.Content.Context)platformContext, debugLog, appStore, apiKey, userId);
    }

    public void Identify(string userId)
    {
        RevenueCat.RevenueCatManager.Identify(userId);
    }
